...
import com.limonanarchy.anticheat.checks.BlinkCheck;
import com.limonanarchy.anticheat.checks.CombatCheck;
import com.limonanarchy.anticheat.checks.CriticalsCheck;
import com.limonanarchy.anticheat.checks.ExemptionListener;
import com.limonanarchy.anticheat.checks.FastBreakCheck;
import com.limonanarchy.anticheat.checks.FlyCheck;
import com.limonanarchy.anticheat.checks.JesusCheck;
...
public class AntiCheatPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.jesusCheck = new JesusCheck(this, violationManager);
        this.criticalsCheck = new CriticalsCheck(this, violationManager);
        this.fastBreakCheck = new FastBreakCheck(this, violationManager);
        this.blinkCheck = new BlinkCheck(this, violationManager);
        this.timerCheck = new TimerCheck(this, violationManager);
        ...
        getServer().getPluginManager().registerEvents(criticalsCheck, this);
        getServer().getPluginManager().registerEvents(fastBreakCheck, this);
        getServer().getPluginManager().registerEvents(blinkCheck, this);
